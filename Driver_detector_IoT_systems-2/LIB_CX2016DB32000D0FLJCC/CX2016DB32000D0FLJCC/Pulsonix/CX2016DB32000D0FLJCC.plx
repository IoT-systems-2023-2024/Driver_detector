...
(library Library_1
	...
	(compDef "CX2016DB32000D0FLJCC" (originalName "CX2016DB32000D0FLJCC") (compHeader (numPins 4) (numParts 1) (refDesPrefix Y)
		...
		(compPin "1" (pinName "HOT_1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "GND_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "HOT_2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/CX2016DB32000D0FLJCC.pdf")
		(attr "<Component Height>" "0.45")
		(attr "<STEP Filename>" "CX2016DB32000D0FLJCC.stp")
