...
//12239024/1245619/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(padStyleDef "r175_145"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 1.45) (shapeHeight 1.75))
		(padShape (layerNumRef 16) (padShapeType Ellipse)  (shapeWidth 0) (shapeHeight 0))
	)
	(textStyleDef "Normal"
		(font
	...
	(patternDef "SOP65P490X110-9N" (originalName "SOP65P490X110-9N")
		(multiLayer
			...
			(pad (padNum 9) (padStyleRef r175_145) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "TPS62842DGRR" (originalName "TPS62842DGRR")
	...
	(compDef "TPS62842DGRR" (originalName "TPS62842DGRR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VOS") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "4" (pinName "VSET") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "GND_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "GND_1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "NC") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VIN") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "EN") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS62842DGRR"))
		...
		(attr "Mouser Part Number" "595-TPS62842DGRR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS62842DGRR?qs=xZ%2FP%252Ba9zWqbpi7pDQDs52A%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS62842DGRR")
		(attr "Description" "Switching Voltage Regulators 60-nA IQ, 1.8-V to 6.5-VIN, high-efficiency 750-mA step-down converter 8-HVSSOP -40 to 125")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tps62840.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TPS62842DGRR.stp")
