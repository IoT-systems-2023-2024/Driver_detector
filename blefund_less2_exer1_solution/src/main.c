...
#define RUN_LED_BLINK_INTERVAL 1000  // --> hier send interval van maken
...
void main(void)
{
	...
	while (1) {		/* LOOP FOREVER */
		...
		k_sleep(K_MSEC(RUN_LED_BLINK_INTERVAL));  /* Een ander interval kiezen (+ alles van die LEDs uit de code halen)*/
		}
